    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center">
          ...
          <div class="hidden lg:flex items-center">
            ...
            <div class="-mb-1">
              <a class="github-button" href="https://github.com/themewagon/windster" data-color-scheme="no-preference: dark; light: light; dark: light;" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star themesberg/windster-tailwind-css-dashboard on GitHub">Star</a>
            </div>
          </div>
    ...
    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
      <div class="flex-1 px-3 bg-white divide-y space-y-1">
        <ul class="space-y-2 pb-2">
          ...
          <li>
            <a href="https://themewagon.github.io/windster/" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
          ...
          <li>
            <a href="https://themewagon.github.io/windster/users/list/" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
          ...
          <li>
            <a href="https://themewagon.github.io/windster/e-commerce/products/" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
          ...
          <li>
            <a href="https://themewagon.github.io/windster/authentication/sign-in/" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
          ...
          <li>
            <a href="https://themewagon.github.io/windster/authentication/sign-up/" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
        ...
        <div class="space-y-2 pt-2">
          <a href="https://themewagon.github.io/windster/pricing/" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
          ...
          <a href="https://flowbite.com/docs/components/accordion/" target="_blank"  class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
...
<p class="text-center text-sm text-gray-500 my-10">
  ...
  <a href="https://themewagon.com" class="hover:underline" target="_blank"
    >ThemeWagon.</a
  >
</p>
