                        ...
                        <div class="align-middle inline-block min-w-full">
                            <div class="shadow overflow-hidden">
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @forelse($users as $user)
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="p-4 whitespace-nowrap text-base font-normal text-gray-900">
                                                <div class="flex items-center">
                                                    <div
                                                        class="h-2.5 w-2.5 rounded-full {{ $user->email_verified_at ? 'bg-green-400' : 'bg-red-500' }} mr-2">
                                                    </div>
                                            ...
                                            <td class="p-4 whitespace-nowrap space-x-2">
                                                <a href="#"
                                                    class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">Edit
                                                    user</a>
                                                <form action="#" method="POST" class="inline-block"
                                                    ...
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">Delete
                                                        user</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="6" class="p-4 text-center text-gray-500">No users found.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
                                <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                    <img class="h-10 w-10 rounded-full"
                                        src="https://themewagon.github.io/windster/images/users/roberta-casas.png"
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                        <img class="h-10 w-10 rounded-full"
                                            src="https://themewagon.github.io/windster/images/users/michael-gough.png"
                                            alt="Michael Gough avatar">
                                        <div class="text-sm font-normal text-gray-500">
                                            <div class="text-base font-semibold text-gray-900">Michael Gough</div>
                                            <div class="text-sm font-normal text-gray-500">michael.gough@windster.com
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">React
                                        developer</td>
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                        <img class="h-10 w-10 rounded-full"
                                            src="https://themewagon.github.io/windster/images/users/jese-leos.png"
                                    ...
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">Marketing
                                    </td>
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">United States
                                    </td>
                                    <td class="p-4 whitespace-nowrap text-base font-normal text-gray-900">
                                        <div class="flex items-center">
                                            <div class="h-2.5 w-2.5 rounded-full bg-green-400 mr-2"></div> Active
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                        <img class="h-10 w-10 rounded-full"
                                            src="https://themewagon.github.io/windster/images/users/bonnie-green.png"
                                            alt="Bonnie Green avatar">
                                        <div class="text-sm font-normal text-gray-500">
                                            <div class="text-base font-semibold text-gray-900">Bonnie Green</div>
                                            <div class="text-sm font-normal text-gray-500">bonnie.green@windster.com
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">UI/UX
                                        Engineer</td>
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">Australia
                                    </td>
                                    <td class="p-4 whitespace-nowrap text-base font-normal text-gray-900">
                                        <div class="flex items-center">
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                        <img class="h-10 w-10 rounded-full"
                                            src="https://themewagon.github.io/windster/images/users/thomas-lean.png"
                                            alt="Thomas Lean avatar">
                                        <div class="text-sm font-normal text-gray-500">
                                            <div class="text-base font-semibold text-gray-900">Thomas Lean</div>
                                            <div class="text-sm font-normal text-gray-500">thomas.lean@windster.com
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">Vue developer
                                    </td>
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                        <img class="h-10 w-10 rounded-full"
                                            src="https://themewagon.github.io/windster/images/users/helene-engels.png"
                                            alt="Helene Engels avatar">
                                        <div class="text-sm font-normal text-gray-500">
                                            <div class="text-base font-semibold text-gray-900">Helene Engels</div>
                                            <div class="text-sm font-normal text-gray-500">helene.engels@windster.com
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">Product owner
                                    </td>
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                        <img class="h-10 w-10 rounded-full"
                                            src="https://themewagon.github.io/windster/images/users/lana-byrd.png"
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                        <img class="h-10 w-10 rounded-full"
                                            src="https://themewagon.github.io/windster/images/users/leslie-livingston.png"
                                            alt="Leslie Livingston avatar">
                                        <div class="text-sm font-normal text-gray-500">
                                            <div class="text-base font-semibold text-gray-900">Leslie Livingston</div>
                                            <div class="text-sm font-normal text-gray-500">
                                                leslie.livingston@windster.com</div>
                                        </div>
                                    </td>
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">Web developer
                                    </td>
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                        <img class="h-10 w-10 rounded-full"
                                            src="https://themewagon.github.io/windster/images/users/robert-brown.png"
                                            alt="Robert Brown avatar">
                                        <div class="text-sm font-normal text-gray-500">
                                            <div class="text-base font-semibold text-gray-900">Robert Brown</div>
                                            <div class="text-sm font-normal text-gray-500">robert.brown@windster.com
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">Laravel
                                        developer</td>
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                        <img class="h-10 w-10 rounded-full"
                                            src="https://themewagon.github.io/windster/images/users/neil-sims.png"
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                        ...
                                        <div class="text-sm font-normal text-gray-500">
                                            <div class="text-base font-semibold text-gray-900">Roberta Casas</div>
                                            <div class="text-sm font-normal text-gray-500">roberta.casas@windster.com
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">Designer</td>
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">Web
                                        developer</td>
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">France</td>
                                    <td class="p-4 whitespace-nowrap text-base font-normal text-gray-900">
                                        <div class="flex items-center">
                            ...
                            <div class="p-6 space-y-6">
                                <form action="#">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="last-name"
                                                class="text-sm font-medium text-gray-900 block mb-2">Last Name</label>
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="current-password"
                                                class="text-sm font-medium text-gray-900 block mb-2">Current
                                                Password</label>
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="new-password"
                                                class="text-sm font-medium text-gray-900 block mb-2">New
                                                Password</label>
